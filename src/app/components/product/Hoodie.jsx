...
export const HoodieData = [
  { id: 17, name: "Jordan Brooklyn Fleece", image: "/image-hoodie/hoodie1.png",price:"69.9",description:"L'emblématique sweat à capuche Tech Fleece Windrunner fait son grand retour. Poche pratique sur la manche. Liserés sur l'ourlet et les poignets. Chevron collé. Cette version arbore tous les détails qui ont fait la renommée du modèle original.", category: "Men" },
  { id: 18, name: "PSG Women's Hoodie", image: "/image-hoodie/hoodie2.png",price:"79.9",description:"Mise tout sur le confort avec ce sweat à capuche ample en molleton. Douceur et respirabilité : le tissu bouclé d'épaisseur moyenne est lisse à l'extérieur et doux à l'intérieur.", category: "Women" },
  { id: 19, name: "Nike Sport Kids Hoodie", image: "/image-hoodie/hoodie3.png",price:"89.9",description:"Incontournable de votre garde-robe, le sweat à capuche Nike Sportswear Club associe douceur, confort et style classique.", category: "Kids" },
  { id: 20, name: "Jordan Men's Hoodie", image: "/image-hoodie/hoodie4.png",price:"49.9",description:"Célébrez la puissance et la simplicité du Swoosh. Ce sweat à capuche en tissu Fleece brossé et chaud offre plus d’espace au niveau des épaules, de la poitrine et du corps pour un confort optimal et un style nostalgique décontracté. Les poignets et l'ourlet côtelés, épais et extensibles permettent de maintenir le sweat à capuche en place lorsque vous bougez et conservent la chaleur lorsqu'il fait froid. Notre Solo Swoosh est brodé sur le côté gauche de la poitrine pour un look épuré et décontracté.", category: "Men" },
  { id: 21, name: "Nike Club Fleece Women's", image: "/image-hoodie/hoodie5.png",price:"69.9",description:" Un superbe look stylé sur le terrain et au quotidien avec notre tissu Fleece premium léger. Lisse à l'intérieur comme à l'extérieur, ce sweat à capuche te tient chaud sans t'encombrer. En plus, son tissu anti-transpirant te garde au sec et à l'aise quand le rythme s'accélère.", category: "Women" },
  { id: 22, name: "Jordan MJ Brooklyn Kids", image: "/image-hoodie/hoodie6.png",price:"79.9",description:"Les entraînements par temps froid ne sont qu'un défi de plus à relever avec notre pull anti-transpirant Nike. Tissu doux et coupe décontractée : tu profites d'un confort optimal pour enchaîner les répétitions. ", category: "Kids" },
  { id: 23, name: "Nike Sport Men's", image: "/image-hoodie/hoodie7.png",price:"129.9",description:"On a revisité un essentiel Jordan et on l'a rendu plus confortable. Lisse à l'extérieur et brossé à l'intérieur, ce sweat à capuche ample en Fleece présente un effet délavé intégral pour un look usé parfait. Le patch ton sur ton et le cordon de serrage à embouts métalliques ajoutent la touche Jordan signature.", category: "Men" },
  { id: 24, name: "Nike Dry Women's", image: "/image-hoodie/hoodie8.png",price:"119.9",description:"LA pièce incontournable à porter tous les jours ? C'est le sweat à capuche confortable, bien sûr. Cet incontournable est confectionné en Fleece brossé d'épaisseur moyenne, ultra-doux à l'intérieur et lisse à l'extérieur.", category: "Women" },
];
