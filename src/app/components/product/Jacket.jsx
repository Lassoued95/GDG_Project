...
export const JacketData = [
  { id: 25, name: "Nike Academy Jacket", image: "/image-jacket/jacket1.png",description:"Le vent, la pluie, la neige, le froid glacial, la chaleur, le soleil de la montagne… Avec la collection ACG, tu peux tout surmonter en extérieur. Ces pièces confortables haute performance sont équipées de différentes technologies pour t'aider à relever tous les défis, quelle que soit la météo (GORE-TEX, PrimaLoft®, Storm-FIT ADV, Therma-FIT ADV).", category: "Men" },
  { id: 26, name: "Nike Sportswear Women's ", image: "/image-jacket/jacket2.png",description:"Zippe ta veste et sors prendre l'air avec cette veste tissée ample. Empiècements indéchirables et résistants. Tissu respirant. Capuche spacieuse. Cette veste t'offre le style rétro, le confort et la protection que tu recherches.", category: "Women" },
  { id: 27, name: "PSG Kids Jacket", image: "/image-jacket/jacket3.png",description:"Notre veste Windrunner culte est prête à ouvrir un nouveau chapitre. Créée pour les jours de pluie, cette veste de running ultra-légère est déperlante pour que tu restes toujours au sec. Et quand il fait beau ? Son tissu anti-UV assure une protection totale au niveau des zones couvertes par la veste. Enfin, elle est compacte et très respirante pour te garder au frais quand tu cours, quelle que soit la longueur de ton parcours.", category: "Kids" },
  { id: 28, name: "Jordan  Jacket", image: "/image-jacket/jacket4.png",description:"Modèle incontournable et icône du running, voici la version revisitée de la veste Nike Miler. Ce modèle déperlant comporte une capuche pour te protéger des intempéries. Repliable, il affiche un look imprégné de l'histoire de Nike. Ce produit est entièrement fabriqué à partir de fibres de polyester recyclé", category: "Men" },
  { id: 29, name: "Nike trom-FIT Academy23 ", image: "/image-jacket/jacket5.png",description:"Conçu aussi bien pour un match, un voyage ou un après-midi de congé, notre survêtement Academy anti-transpirant te garantit une protection totale. L'ensemble pantalon et haut est doux et léger. Les aérations dans les endroits stratégiques te procurent juste ce qu'il faut de fraîcheur.", category: "Women" },
  { id: 30, name: "Jordan Renegade Kids", image: "/image-jacket/jacket6.png",description:"La veste aviateur a toujours été iconique, et la Renegade est la version Jordan de ce modèle culte. Tissu tissé doux et déperlant. Coupe ample. Rembourrage chaud et léger. Cette veste a tout ce qu'il faut. Et la poche en losange sur la manche apporte la touche Jordan signature.", category: "Kids" },
  { id: 31, name: "Jordan Jacket", image: "/image-jacket/jacket7.png",description:"Cette veste ne fait pas les choses à moitié. Poche sur la manche avec un Jumpman brodé. Boutons-pression en métal brossé, ornés du logo Jordan. Détails ruchés sur les manches. Tout s'assemble dans ce modèle stylé. Quand le vent se lève, remonte le col doublé en fausse fourrure. C'est le combo parfait entre chaleur et style." ,category: "Men" },
  { id: 32, name: "Jordan 23 Engineered ", image: "/image-jacket/jacket8.png",description:"En journée comme en soirée, notre veste de survêtement Solo Swoosh t'offre le style épuré et classique emblématique de la collection. Le liseré réfléchissant ajoute une touche de contraste au tissu tissé impeccable et léger. Pour un look complet à la maison ou pour faire du shopping, associe-le à notre pantalon de survêtement Solo Swoosh assorti.", category: "Women" },
];
