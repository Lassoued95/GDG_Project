...
export const Shoes = [
  { id: 33, name: "Air Jordan 1 Mid", image: "/image-shoes/shoes1.png",price:"69.9",description:"Le rose est la couleur de la victoire. Cette paire rayonne avec un mélange éclatant de teintes roses. Tout le confort Jordan classique est également présent avec une unité Nike Air dans la semelle pour amortir chaque pas et une semelle cupsole en caoutchouc pour un confort total au quotidien." , category: "Men" },
  { id: 34, name: "Nike Air Max", image: "/image-shoes/shoes2.png",price:"79.9",description:"Relevez tous les défis quotidiens dans le modèle Nike Defy All Day. Le cuir sur le dessus et le caoutchouc en dessous créent un modèle résistant adapté aux rigueurs des sessions d'entraînement intense. L'amorti souple est gage de confort pour votre entraînement ou durant une journée chargée.", category: "Men" },
  { id: 35, name: "Nike React Vision", image: "/image-shoes/shoes3.png",price:"89.9",description:"Confortable, résistante et intemporelle : elle n'est pas classée numéro 1 pour rien. La conception culte des années 80 de la AF1, avec plusieurs détails originaux. Un plaisir sur le terrain comme au quotidien.", category: "Kids" },
  { id: 36, name: "Nike Air Force", image: "/image-shoes/shoes4.png",price:"99.9",description:"Inspirée du corps humain et de l’ADN du running, la Nike Air Max 95 Essential associe un confort incroyable à un style qui ne passe pas inaperçu. Les empiècements latéraux emblématiques représentent les muscles, tandis que l'unité Nike Air visible au talon et à l'avant-pied amortit chaque foulée.", category: "Men" },
  { id: 37, name: "Jordan Max Aura 5", image: "/image-shoes/shoes5.png",price:"79.9",description:"Revendiquez votre côté rebelle avec votre Nike Air Max Plus, un modèle Air novateur qui offre une stabilité optimale et un amorti exceptionnel. Reprenant les lignes ondulées, les détails en TPU et l'empeigne en mesh respirant du modèle d'origine, elle incarne un style rebelle.", category: "Men" },
  { id: 38, name: "G.T.Hustle Academy", image: "/image-shoes/shoes6.png",price:"69.9",description:"Découvre la chaussure qui saura résister aux exigences d'une séance de fitness rythmée et d'une journée intense de musculation. Un talon plat, des matières résistantes et une semelle souple : tu as tout le confort et le maintien nécessaires pour faire du sport n'importe où et à tout moment.", category: "Women" },
  { id: 39, name: "LeBron", image: "/image-shoes/shoes7.jpeg",price:"59.9",description:"La dernière fois, LeBron a bouleversé le monde du basket avec ses chaussures, comme lui seul sait le faire. La nouvelle version va encore plus loin. Système de câblage. Amorti Zoom Air. Construction légère. Conception près du sol. La LeBron XXI assure fluidité et explosivité sans t'alourdir. Créée pour dominer ses adversaires, elle est idéale pour les attaques à pleine vitesse façon LeBron et pour s'envoler vers le panier quand le match s'intensifie.", category: "Men" },
  { id: 40, name: "Nike Air Force", image: "/image-shoes/shoes8.png",price:"119.9",description:"Le confort est roi, mais pas au détriment du style. S'inspirant de la AJ1 et de la AJ5, la Stadium 90 est parfaite pour le quotidien. L'empeigne en cuir et tissu tissé est à la fois résistante et respirante. L'amorti Nike Air dans la semelle offre légèreté et amorti à chaque pas.", category: "Women" },
];
