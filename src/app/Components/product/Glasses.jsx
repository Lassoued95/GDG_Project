...
export const productsG = [
  ...
  { id: 57, name: "Nike Show X1", image: "/image-glasses/glasses1.png" ,price:"79.9", category :"Men", description:"Sometimes it's hard to pull yourself away from the screen. The Nike Blue Light Collection features a premium lens coating that helps reduce blue light exposure for use at home, office and gaming on your digital devices." },
  { id: 58, name: "Nike Zeus", image: "/image-glasses/glasses2.png" , price:"59.9",cprice:"69.9",ategory :"Women",description:"A timeless classic for every day, the Nike Crescent I sunglasses utilize 20% recycled content by weight with a chunky, throwback design reminiscent of vintage shades. The smooth, square shape continues through angular beveled edges with minimalist logos at each temple etched in sleek, silver-tone hardware."},
  { id: 59, name: "Nike Circuit", image: "/image-glasses/glasses3.jpg" ,price:"79.9", category :"Men",description:"Reimagining sport shields for every day, the Nike Marquee Edge sunglasses offer panoramic views in an ultralight frame. The angular design accommodates a wide lens and has rubberized zones at the top bar, nose pad and temples to give you a grippy, stay-put fit while adding unexpected pops of bold color."},
  { id: 60, name: "Nike Athena", image: "/image-glasses/glasses4.jpg" ,price:"79.9",price:"79.9", category :"Kids",description:"When your casual walk turns into a spontaneous run, find all-around comfort in the Nike Metal Fusion sunglasses. They're lightweight, durable and easy to get a locked-in fit with the adjustable, rubberized temple tips and nose pads for when the day suddenly cranks into high gear."},
  { id: 61, name: "Nike State", image: "/image-glasses/glasses5.jpg", price:"79.9",price:"89.9",category :"Women" ,description:" The Nike State  sunglasses are equally stylish as they are comfortable. These shades are vintage-inspired in looks with an oversized, rounded shape and built for ease with softly rubberized and adjustable temple tips that bend for effortless adjustability."},
  { id: 62, name: "Nike Essential Horizon", image: "/image-glasses/glasses6.jpg" ,price:"79.9", category :"Women",description:"Sometimes it's hard to pull yourself away from the screen. The Nike Essential Horizon Collection features a premium lens coating that helps reduce blue light exposure for use at home, office, and gaming on your digital devices."},
  { id: 63, name: "Nike Crescent", image: "/image-glasses/glasses7.png" ,price:"99.9", category :"Men",description:"With their square lenses and keyhole nose bridge design, you'll carve your own style path through those sunny days. Lightweight but durable, the nylon frame and slim profile provide the coverage and comfort you need for all-day adventures."},
  { id: 64, name: "Nike NV05 LB", image: "/image-glasses/glasses8.jpg" ,price:"89.9", category :"Women",description:"magine unrestricted vision in a wrap-tight fit with streetwear style. Reimagining sport shields for every day, the Marquee sunglasses offer panoramic views in an ultralight frame made from mixed materials. The rubberized zones at the top bar, nose pad and temples help give you a grippy, stay-put fit while adding unexpected pops of bold color."},
