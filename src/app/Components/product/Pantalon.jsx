...
export const productsP = [
  { id: 49, name: "Nike Sportswear Air", image: "/image-Pontalon/pants1.png", price:"69.9",category_prod:'pant', category: "Men", description: "Crafted with stretchy woven material, these Nike Tech pants offer you ease of movement and adjustability. The wide-leg cut is paired with bungee locks at the ankles that let you switch up the fit." },
  { id: 50, name: "Nike ACG", image: "/image-Pontalon/pants2.jpg", price:"69.9", category_prod:'pant', category: "Women", description: "These loose fitting, straight leg pants take you from work to the weekend in crisp, clean style. They're made with supersoft heavyweight canvas, a durable material that stands up to whatever you throw at them." },
  { id: 51, name: "Nike Tech", image: "/image-Pontalon/pants3.png",  price:"59.9",category_prod:'pant', category: "Men", description: "Designed for durability, these carpenter pants are made with heavyweight cotton twill that stands up to routine wear. Their relaxed fit and numerous pockets give them a classic, functional feel." },
  { id: 52, name: "Nike Club Fleece", image: "/image-Pontalon/pants4.png", price:"129.9", category_prod:'pant', category: "Men", description: "Can you believe it's already been 10 years of Tech Fleece? We’re celebrating the occasion with the timeless tailored design you know in a new color palette inspired by natural minerals. Our premium, smooth-on-both-sides fleece feels warmer and softer than ever, while keeping the same lightweight build you love. Complete your look with the matching jacket or your favorite top. The future of fleece starts here." },
  { id: 53, name: "Nike Club", image: "/image-Pontalon/pants5.jpg",  price:"69",category_prod:'pant', category: "Kids", description: "Rooted in the origins of our iconic Air technology, these pants embrace the same commitment to comfort that sets Nike Air apart. The woven cotton fabric is washed for softness and comfort that keeps you cool. Designed with some extra room through the seat and thighs, they also offer an elastic and drawstring waistband for easy entry and removal." },
  { id: 54, name: "Nike Floral Fleece", image: "/image-Pontalon/pants6.jpg", price:"119.9", category_prod:'pant', category: "Women", description: "These pants pair the clean aesthetic of Tech with a roomy fit for a relaxed vibe. Our premium, lightweight fleece–smooth both inside and out–gives you plenty of warmth without adding bulk." },
  { id: 55, name: "Nike Sportswear Essentials", image: "/image-Pontalon/pants7.png",  price:"69.9",category_prod:'pant', category: "Men", description: "Go big on comfort with these spacious Club Fleece pants. Its midweight, loopback fabric offers a soft-but-breathable feel that's smooth on the outside and soft on the inside." },
  { id: 56, name: "Nike Sportswear Essential", image: "/image-Pontalon/pants8.png", price:"99.9", category_prod:'pant', category: "Men", description: "Lightweight and ready for whatever, these woven nylon pants have a water-repellent finish to help you stay dry when rain rolls in. Plus, elastic drawcords at the hem give you styling power. How will you wear 'em?" },
];
function Pantalon() {
